        ...
        try {
            ...
            mProjects.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    ArrayAdapter<String> districts = new ArrayAdapter<String>(AddParticipantActivity.this, android.R.layout.simple_spinner_item,dists);
            ...
            mComponents.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    ArrayAdapter<String> itemsAdapter1 = new ArrayAdapter<String>(AddParticipantActivity.this, android.R.layout.simple_spinner_item, component_sub_component_helper.getSubComponents(component_sub_component_helper.componentID(myComponent)));
            ...
            mSubComponents.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    ArrayAdapter<String> acts = new ArrayAdapter<String>(AddParticipantActivity.this, android.R.layout.simple_spinner_item, component_sub_component_helper.getActivitiesOfSubComponent(component_sub_component_helper.subComponentId(mySubComponent)));
...
//            mDistricts.setAdapter(districts);
            ...
            mDistricts.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    ArrayAdapter<String> acts = new ArrayAdapter<String>(AddParticipantActivity.this, android.R.layout.simple_spinner_item, wrds);
                    acts.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            ...
            mSave.setOnClickListener(v -> {
                try {
                    ...
                    if(mAppointments.getSelectedItem().toString().equalsIgnoreCase("--Select Option--")){
                        Toast.makeText(this, "Select all options", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    String insert = activities_helper.insertParticipant(project_id, comp_id, sub_comp_id, activity_id, district_id, ward_id, fname, surname, natid, sex, yob, contact,appointment_id,this);
